...
- **201 tools, sensibly scoped** — 30 high-value *core* tools are on by default; 171 more
...
The plugin exposes **201 tools** in six categories. Each links to a full, per-tool reference.
...
| [Debug & Runtime](docs/tools/debug-tools.md) | 70 | Logs, debugger, breakpoints, profilers, live runtime control |
| [Project](docs/tools/project-tools.md) | 53 | Settings, resources, input map, audits, 4.7 migration, assets |

Only the 30 **core** tools are enabled by default — enable any of the 171 **advanced** tools
