...
func _build_classifications() -> void:
	var classifications: Array[Dictionary] = [
		...
		{"name": "create_custom_resource", "category": "supplementary", "group": "Project-Advanced"},
		{"name": "batch_create_resources", "category": "supplementary", "group": "Project-Advanced"},
		{"name": "update_resource_properties", "category": "supplementary", "group": "Project-Advanced"},
		{"name": "read_resource_properties", "category": "supplementary", "group": "Project-Advanced"},
		...
		{"name": "close_script_tab", "category": "supplementary", "group": "Editor-Advanced"},
		{"name": "get_import_status", "category": "supplementary", "group": "Editor-Advanced"},
		...
		{"name": "batch_get_node_properties", "category": "supplementary", "group": "Node-Advanced"},
		{"name": "batch_connect_signals", "category": "supplementary", "group": "Node-Advanced"},
