...
- **作者**：xianyu0514（上游原作者）| **版本**：1.0.7-pre1
- **许可证**：MIT
- **渲染器**：GL Compatibility
- **Fork 维护**：本仓库 `RedGD` 由 JiaHuiRed 维护，fork 自 [xianyu0514/GodotMcp-XY](https://github.com/xianyu0514/GodotMcp-XY)，持续同步上游修复，主要配合 RedMon 项目开发时驱动 Godot 编辑器
